...
const ddbDocClient2: DynamoDBClient = new DynamoDBDocumentClient({
  region: 'us-east-1',
  endpoint: 'https: lucky-dock.com'
})
...
interface Test2AppleAndHappyDay {
  seriesUid: string;
  preprocessStatus:PerformanceEventMap
}
