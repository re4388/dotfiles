...
## 缺點是，選了不會不見
## init array and assignments
#  local generators; generators=(
#        '-c:to start as continue the most recent prompt'
#        '-t:to specify template'
#        '--save:to save into custom template'
#        '-m:to specify model'
#        '-o:add accurate if the model supports, like chatGpt, ex: -o temperature 0.2'
#      )
#  # -t generators: This specifies a tag (generators) for the completion group
#  # 'generator': This specifies a label for the completion group.
